...
//  , gif_image_(nullptr)
{
  ...
  //  groupVertexFormButtons();
  //  groupLineFormButtons();

  //  creatGroupToolBarMainAction();
  //  creatGroupToolBarModelAction();
  //  creatGroupToolBarLightAction();
...
void MainWindow::groupVertexFormButtons()
{
  m_groupVertForm.addButton(ui->cB_vert_none);
  m_groupVertForm.setId(ui->cB_vert_none, vertType::None);

  m_groupVertForm.addButton(ui->cB_vert_circle);
  m_groupVertForm.setId(ui->cB_vert_circle, vertType::Circle);

  m_groupVertForm.addButton(ui->cB_vert_square);
  m_groupVertForm.setId(ui->cB_vert_square, vertType::Square);
}

void MainWindow::groupLineFormButtons()
{
  m_groupLineForm.addButton(ui->cB_line_solid);
  m_groupLineForm.setId(ui->cB_line_solid, lineType::Solid);

  m_groupLineForm.addButton(ui->cB_line_dashed);
  m_groupLineForm.setId(ui->cB_line_dashed, lineType::Dashed);
}

// void MainWindow::creatGroupToolBarMainAction()
//{
//  m_toolBarMainAction->addAction(ui->act_add_new_model);
//  m_toolBarMainAction->addAction(ui->act_add_light_source);
//  m_toolBarMainAction->addAction(ui->act_screenshot);
//  m_toolBarMainAction->addAction(ui->act_gif);
//  m_toolBarMainAction->addAction(ui->act_gif_360);
//  m_toolBarMainAction->addAction(ui->act_backup);
//  m_toolBarMainAction->addAction(ui->act_projection);
//  m_toolBarMainAction->addAction(ui->act_light_on_off);
//  m_toolBarMainAction->addAction(ui->act_shade);
//}

// void MainWindow::creatGroupToolBarModelAction()
//{
//  m_toolBarModelAction->addAction(ui->act_model_rtc);
//   m_toolBarModelAction->
//  m_toolBarModelAction->addAction(ui->act_color_setting_model);
//  m_toolBarModelAction->addAction(ui->act_settings_model);
//  m_toolBarModelAction->addAction(ui->act_axis_rotate);
//  m_toolBarModelAction->addAction(ui->act_texture);
//  m_toolBarModelAction->addAction(ui->act_info);
//  m_toolBarModelAction->addAction(ui->act_delete_model);
//}

// void MainWindow::creatGroupToolBarLightAction()
//{
//  m_toolBarLightAction->addAction(ui->act_light_position);
//  m_toolBarLightAction->addAction(ui->act_light_color);
//  m_toolBarLightAction->addAction(ui->act_light_settings);
//}

void MainWindow::setSlots()
{
  //  /*--------------QActionGroups-------------------*/
  //  connect(m_toolBarMainAction, SIGNAL(triggered(QAction*)), this, SLOT(triggeredGroupMainAction(QAction*)));
  //  connect(m_toolBarModelAction, SIGNAL(triggered(QAction*)), this, SLOT(triggeredGroupModelAction(QAction*)));
  //  connect(m_toolBarLightAction, SIGNAL(triggered(QAction*)), this, SLOT(triggeredGroupLightAction(QAction*)));

  //  /*-------------QButtonGroups--------------*/
  //  connect(&m_groupVertForm, SIGNAL(idClicked(int)), this, SLOT(clickedVertForm(int)));
  //  connect(&m_groupLineForm, SIGNAL(idClicked(int)), this, SLOT(clickedLineForm(int)));

  //  /*-------------QComboBox--------------*/
  //  connect(ui->comboBox_drawingType, SIGNAL(currentIndexChanged(int)), this, SLOT(comboBoxIndexChanged(int)));

  //  /*-----QToolButtons------*/
  //  connect(ui->tB_reset_rts_model, SIGNAL(clicked()), this, SLOT(buttonResetRtsModelClicked()));
  //  connect(ui->tB_model_min_max_rts, SIGNAL(clicked()), this, SLOT(buttonMinMaxRtsClicked()));
  //  connect(ui->tB_back_to_rts_model, SIGNAL(clicked()), this, SLOT(buttonBackToRtsModelClicked()));

  //  connect(ui->tB_prev_condition, SIGNAL(clicked()), this, SLOT(buttonPrevConditionClicked()));
  //  connect(ui->tB_next_condition, SIGNAL(clicked()), this, SLOT(buttonNextConditionClicked()));
  //  connect(ui->tB_save_condition, SIGNAL(clicked()), this, SLOT(buttonSaveConditionClicked()));
  //  connect(ui->tB_clear_conditions, SIGNAL(clicked()), this, SLOT(buttonClearConditionClicked()));

  //  // кнопка для возврата к изменению матрицы модели

  //  // кнопка для сброса матрицы модели к дэфолтным
  //  connect(ui->toolButton_reset_matrix_model, SIGNAL(clicked()), this, SLOT(buttonResetModelClicked()));
  //  // кнопки для автоповоротов по осям
  //  connect(ui->toolButton_x_axis_rotate, SIGNAL(clicked()), this, SLOT(buttonsRotateAxisClicked()));
  //  connect(ui->toolButton_y_axis_rotate, SIGNAL(clicked()), this, SLOT(buttonsRotateAxisClicked()));
  //  connect(ui->toolButton_x_y_axis_rotate, SIGNAL(clicked()), this, SLOT(buttonsRotateAxisClicked()));
  //  connect(ui->toolButton_right_auto_rotate, SIGNAL(clicked()), this, SLOT(buttonsTurnRotateAxisClicked()));
  //  connect(ui->toolButton_left_auto_rotate, SIGNAL(clicked()), this, SLOT(buttonsTurnRotateAxisClicked()));
  //  connect(ui->toolButton_play_stop_rotate, SIGNAL(clicked()), this, SLOT(buttonsPlayStopRotateAxisClicked()));
  //  /*----------------------*/

  //  /*-----QPushButtons------*/
  //  // пятна блика освещения на объекте
  //  connect(ui->pushButton_specular_color, SIGNAL(clicked()), this, SLOT(colorsButtonClicked()));
  //  /*----------------------*/

  //  /*------------QSliders-----------------*/
  //  // слайдеры для изменения матрциы модели
  //  connect(ui->slider_M_RX, SIGNAL(valueChanged(int)), this, SLOT(slidersModelChanged(int)));
  //  connect(ui->slider_M_RY, SIGNAL(valueChanged(int)), this, SLOT(slidersModelChanged(int)));
  //  connect(ui->slider_M_RZ, SIGNAL(valueChanged(int)), this, SLOT(slidersModelChanged(int)));
  //  connect(ui->slider_M_TX, SIGNAL(valueChanged(int)), this, SLOT(slidersModelChanged(int)));
  //  connect(ui->slider_M_TY, SIGNAL(valueChanged(int)), this, SLOT(slidersModelChanged(int)));
  //  connect(ui->slider_M_TZ, SIGNAL(valueChanged(int)), this, SLOT(slidersModelChanged(int)));
  //  connect(ui->slider_M_Scale, SIGNAL(valueChanged(int)), this, SLOT(slidersModelChanged(int)));
  //  // слайдеры для изменения толщины линий и размера вершин
  //  connect(ui->slider_vertex_size, SIGNAL(valueChanged(int)), this, SLOT(slidersModelSettingsChanged(int)));
  //  connect(ui->slider_line_size, SIGNAL(valueChanged(int)), this, SLOT(slidersModelSettingsChanged(int)));
  //  // слайдер для изменения specular фактора
  //  connect(ui->slider_specular_factor, SIGNAL(valueChanged(int)), this, SLOT(slidersLightSettingsChanged(int)));
  //  // слайдер для изменения силы света
  //  connect(ui->slider_light_power, SIGNAL(valueChanged(int)), this, SLOT(slidersLightSettingsChanged(int)));
  //  // слайдеры для изменения rgb оснвоного освещения
  //  connect(ui->slider_light_color_red, SIGNAL(valueChanged(int)), this, SLOT(slidersLightSettingsChanged(int)));
  //  connect(ui->slider_light_color_green, SIGNAL(valueChanged(int)), this, SLOT(slidersLightSettingsChanged(int)));
  //  connect(ui->slider_light_color_blue, SIGNAL(valueChanged(int)), this, SLOT(slidersLightSettingsChanged(int)));
  //  // слайдер для изменения ширины экрана приложения
  //  connect(ui->slider_width_screen, SIGNAL(valueChanged(int)), this, SLOT(slidersSettingsScreenChanged(int)));
  //  // слайдер для изменения высоты экрана приложения
  //  connect(ui->slider_height_screen, SIGNAL(valueChanged(int)), this, SLOT(slidersSettingsScreenChanged(int)));
  //  /*------------------------------------*/

  //  /*------------QDoubleSpinBoxes-----------------*/
  //  // спинбоксы матрицы модели
  //  connect(ui->doubleSpinBox_M_RX, SIGNAL(valueChanged(double)), this, SLOT(doubleSpinboxModelChanged(double)));
  //  connect(ui->doubleSpinBox_M_RY, SIGNAL(valueChanged(double)), this, SLOT(doubleSpinboxModelChanged(double)));
  //  connect(ui->doubleSpinBox_M_RZ, SIGNAL(valueChanged(double)), this, SLOT(doubleSpinboxModelChanged(double)));
  //  connect(ui->doubleSpinBox_M_TX, SIGNAL(valueChanged(double)), this, SLOT(doubleSpinboxModelChanged(double)));
  //  connect(ui->doubleSpinBox_M_TY, SIGNAL(valueChanged(double)), this, SLOT(doubleSpinboxModelChanged(double)));
  //  connect(ui->doubleSpinBox_M_TZ, SIGNAL(valueChanged(double)), this, SLOT(doubleSpinboxModelChanged(double)));
  //  connect(ui->doubleSpinBox_M_Scale, SIGNAL(valueChanged(double)), this, SLOT(doubleSpinboxModelChanged(double)));
  //  // спинбоксы освещения объекта
  //  connect(ui->doubleSpinBox_x, SIGNAL(valueChanged(double)), this, SLOT(doubleSpinBoxLightChanged(double)));
  //  connect(ui->doubleSpinBox_y, SIGNAL(valueChanged(double)), this, SLOT(doubleSpinBoxLightChanged(double)));
  //  connect(ui->doubleSpinBox_z, SIGNAL(valueChanged(double)), this, SLOT(doubleSpinBoxLightChanged(double)));
  ...
  //  SLOT(doubleSpinBoxMinMaxChanged(double))); connect(ui->doubleSpinBox_max_scale, SIGNAL(valueChanged(double)),
  //  this, SLOT(doubleSpinBoxMinMaxChanged(double)));
  //  /*---------------------------------------------*/
  //  connect(ui->openGLWidget, SIGNAL(resized()), this, SLOT(set_doubleSpinBox_width_height()));
  ...
  //  connect(gif_maker_, SIGNAL(Finished()), gif_thread_, SLOT(quit()), Qt::DirectConnection);
  //  connect(gif_maker_, SIGNAL(SaveGif()), this, SLOT(SaveGifImage()));

  //  // endless camera rotation
  //  connect(gif_maker_, SIGNAL(IdleRotateRequested()), gif_thread_, SLOT(start()));
  //  connect(gif_maker_, SIGNAL(RequestIdleRotateStep()), this, SLOT(MakeIdleRotateStep()));
}
...
//  ui->toolButton_right_auto_rotate->setIcon(QIcon(":/icons_ui/auto_rotate_right_YES.png"));
//  ui->toolButton_left_auto_rotate->setIcon(QIcon(":/icons_ui/auto_rotate_left_NO.png"));
...
//    ui->act_projection->setIcon(QIcon(":/icons_ui/perpectiveProj.png"));
//  }
//  ui->openGLWidget->resizeGL(ui->openGLWidget->geometry().width(), ui->openGLWidget->geometry().height());
//  ui->openGLWidget->update();
//}

// void MainWindow::action_open_folder()
//{
//  QString filePath = QFileDialog::getOpenFileName(this, "Select a file to open...", QDir::homePath(), "*.obj");
//  if (!filePath.isEmpty())
//  {
//    bool loading_flag = controller.add_object(filePath);
//    if (loading_flag == false)
//    {
//      QMessageBox::warning(this, "Information", "Incorrect obj. File. Please retry load another!");
//    }
//    else
//    {
...
//                                      // скидываем до 0
//      ui->act_modelCamera->setIcon(QIcon(":/icons_ui/model_camera.png"));  // изменение иконки для модели
//                                                                           // камеры
...
//    {
//      QString filePath = QFileDialog::getOpenFileName(this, "Select a file to open...", QDir::homePath(), "*.png");
//      if (!filePath.isEmpty())
//      {
...
//    QString nameTextureObj = info_object.getPathToTextureObj().split("/").back();
...
//    info += QString("\n\nTexture = %1").arg(YesNo);
//    info += YesNo == "No" ? QString("") : QString("\n\nName texture file = %1").arg(nameTextureObj);
//    info += YesNo == "No" ? QString("") : QString("\n\nTexture path model =
//    %1").arg(info_object.getPathToTextureObj());
//  }
//  else
//  {
...
//  ui->act_modelCamera->setIcon(QIcon(":/icons_ui/unActiveModel.png"));  // изменение иконки для модели камеры
//  ui->openGLWidget->update();                                           // перерисовка объекта
//}
...
//    if (currentBut == ui->backgroundColorButton)
//    {  //  изменения цвета заднего фона
//      controller.set_bg_color_sets(color.redF(), color.greenF(), color.blueF(), color.alphaF());
//      ui->color_bg->setStyleSheet(css);
//    }
//    else if (currentBut == ui->surfaceColorButton)
//    {  // изменение цвета
//       // поверхностей объекта
//      controller.set_surfaces_color_sets(color.redF(), color.greenF(), color.blueF(), color.alphaF());
//      ui->color_surface->setStyleSheet(css);
//    }
//    else if (currentBut == ui->vertexColorButton)
//    {  // изменение цвета вершин объекта
//      controller.set_vert_color_sets(color.redF(), color.greenF(), color.blueF(), color.alphaF());
//      ui->color_vertex->setStyleSheet(css);
//    }
//    else if (currentBut == ui->linesColorButton)
//    {  // изменение цвета линий объекта
//      controller.set_line_color_sets(color.redF(), color.greenF(), color.blueF(), color.alphaF());
//      ui->color_line->setStyleSheet(css);
//    }
//    else if (currentBut == ui->pushButton_specular_color)
//    {  // изменение цвета пятна блика
//       // освещения
//      controller.setSpecularColor(color.redF(), color.greenF(), color.blueF(), color.alphaF());
//      ui->color_specular_color->setStyleSheet(css);
//    }
//    ui->openGLWidget->update();  // перерисовка объекта
//  }
...
//  {
//    controller.setLightPosition(value, ui->doubleSpinBox_y->value(), ui->doubleSpinBox_z->value());
//  }
//  else if (current == ui->doubleSpinBox_y)
//  {
//    controller.setLightPosition(ui->doubleSpinBox_x->value(), value, ui->doubleSpinBox_z->value());
//  }
//  else if (current == ui->doubleSpinBox_z)
//  {
//    controller.setLightPosition(ui->doubleSpinBox_x->value(), ui->doubleSpinBox_y->value(), value);
//  }
...
//    else
//    {
//      QMessageBox::information(this, "Information", "Sorry, you can save only 100 Conditions!");
//    }
//  }
//}
...
//  {
//    shot = shot.scaled(kGifWidth, kGifHeight, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
//  }
...
//{
//  QString screnshootsDirPath = QCoreApplication::applicationDirPath() + "/screenshots/";
//  if (!QDir(screnshootsDirPath).exists())
//  {
//    QDir().mkdir(screnshootsDirPath);
//  }
//  QString filename = screnshootsDirPath + QDateTime::currentDateTime().toString("ddMMyy-hh-mm-ss");
//  if (ui->openGLWidget->grabFramebuffer().save(filename + ".jpeg") &&
//      ui->openGLWidget->grabFramebuffer().save(filename + ".bmp"))
//    ui->statusBar->showMessage("screenshots saved as: " + filename + "(.jpeg/.bmp)", 5000);
//}
...
//                     QDateTime::currentDateTime().toString("ddMMyy-hh-mm-ss") + ".gif";
...
//      ui->toolButton_x_y_axis_rotate->setIcon(QIcon(":/icons_ui/x_y_axis_OFF.png"));
...
//      ui->toolButton_x_axis_rotate->setIcon(QIcon(":/icons_ui/x_axis_OFF.png"));
//      ui->toolButton_y_axis_rotate->setIcon(QIcon(":/icons_ui/y_axis_OFF.png"));
//      ui->toolButton_x_y_axis_rotate->setIcon(QIcon(":/icons_ui/x_y_axis_ON.png"));
...
//    ui->toolButton_play_stop_rotate->setIcon(QIcon(":/icons_ui/pause-button.png"));
...
//    if (turnAutoRotate_ != turnAutoRotate::LEFT)
//    {
//      ui->toolButton_left_auto_rotate->setIcon(QIcon(":/icons_ui/auto_rotate_left_YES.png"));
//      ui->toolButton_right_auto_rotate->setIcon(QIcon(":/icons_ui/auto_rotate_right_NO.png"));
...
{
  int y = ui->slider_model_rotate_y->value();
  int z = ui->slider_model_rotate_z->value();
  QString rgb = "(" + QString::number(value) + ", " + QString::number(y) + ", " + QString::number(z) + ")";
  ui->label_rotate_model->setText(rgb);
}

void MainWindow::on_slider_model_rotate_y_valueChanged(int value)
{
  int x = ui->slider_model_rotate_x->value();
  int z = ui->slider_model_rotate_z->value();
  QString rgb = "(" + QString::number(x) + ", " + QString::number(value) + ", " + QString::number(z) + ")";
  ui->label_rotate_model->setText(rgb);
}

void MainWindow::on_slider_model_rotate_z_valueChanged(int value)
{
  int x = ui->slider_model_rotate_x->value();
  int y = ui->slider_model_rotate_y->value();
  QString rgb = "(" + QString::number(x) + ", " + QString::number(y) + ", " + QString::number(value) + ")";
  ui->label_rotate_model->setText(rgb);
}

void MainWindow::on_slider_model_translate_x_valueChanged(int value)
{
  int y = ui->slider_model_translate_y->value();
  int z = ui->slider_model_translate_z->value();
  QString rgb = "(" + QString::number(value) + ", " + QString::number(y) + ", " + QString::number(z) + ")";
  ui->label_translate_model->setText(rgb);
}

void MainWindow::on_slider_model_translate_y_valueChanged(int value)
{
  int x = ui->slider_model_translate_x->value();
  int z = ui->slider_model_translate_z->value();
  QString rgb = "(" + QString::number(x) + ", " + QString::number(value) + ", " + QString::number(z) + ")";
  ui->label_translate_model->setText(rgb);
}

void MainWindow::on_slider_model_translate_z_valueChanged(int value)
{
  int x = ui->slider_model_translate_x->value();
  int y = ui->slider_model_translate_y->value();
  QString rgb = "(" + QString::number(x) + ", " + QString::number(y) + ", " + QString::number(value) + ")";
...
{
  if (arg1 >= ui->sB_max_translate->value())
  {
    int value = ui->sB_max_translate->value();
    ui->sB_min_translate->setValue(value);
    ui->slider_model_translate_x->setMinimum(value);
    ui->slider_model_translate_y->setMinimum(value);
    ui->slider_model_translate_z->setMinimum(value);
    return;
  }

  ui->slider_model_translate_x->setMinimum(arg1);
  ui->slider_model_translate_y->setMinimum(arg1);
  ui->slider_model_translate_z->setMinimum(arg1);
}

void MainWindow::on_sB_max_translate_valueChanged(int arg1)
{
  if (arg1 <= ui->sB_min_translate->value())
  {
    int value = ui->sB_min_translate->value();
    ui->sB_max_translate->setValue(value);
    ui->slider_model_translate_x->setMaximum(value);
    ui->slider_model_translate_y->setMaximum(value);
    ui->slider_model_translate_z->setMaximum(value);
    return;
  }

  ui->slider_model_translate_x->setMaximum(arg1);
  ui->slider_model_translate_y->setMaximum(arg1);
  ui->slider_model_translate_z->setMaximum(arg1);
}

void MainWindow::on_sB_min_scale_valueChanged(int arg1)
{
  if (arg1 >= ui->sB_max_scale->value())
  {
    int value = ui->sB_max_scale->value();
    ui->sB_min_scale->setValue(value);
    ui->slider_model_scale->setMinimum(value);
    return;
  }

  ui->slider_model_scale->setMinimum(arg1);
}

void MainWindow::on_sB_max_scale_valueChanged(int arg1)
{
  if (arg1 <= ui->sB_min_scale->value())
  {
    int value = ui->sB_min_scale->value();
    ui->sB_max_scale->setValue(value);
    ui->slider_model_scale->setMaximum(value);
    return;
  }

  ui->slider_model_scale->setMaximum(arg1);
}
